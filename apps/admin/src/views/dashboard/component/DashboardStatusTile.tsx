...
export default function DashboardStatusTile({
  ...
  return (
    <div
      className={`w-full max-w-80 rounded-lg p-3 transition-[transform,box-shadow] duration-200 ease-out motion-safe:animate-[dashboard-row-enter_550ms_var(--row-delay)_var(--dashboard-motion-ease)_both] ${
        isActive
          ? 'bg-linear-to-br from-[#061a35] via-[#0b3f77] to-[#1677a8] text-slate-50'
