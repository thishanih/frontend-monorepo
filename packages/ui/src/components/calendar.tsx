  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:
          'inline-flex size-8 items-center justify-center rounded-md text-blue-600 hover:bg-blue-100 hover:text-blue-700 aria-disabled:pointer-events-none aria-disabled:opacity-40',
        button_next:
          'inline-flex size-8 items-center justify-center rounded-md text-blue-600 hover:bg-blue-100 hover:text-blue-700 aria-disabled:pointer-events-none aria-disabled:opacity-40',
        ...
        day_button:
          'mx-auto inline-flex size-9 items-center justify-center rounded-md p-0 font-normal outline-none transition-colors hover:bg-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 aria-selected:font-semibold',
        ...
        range_middle: 'rounded-none bg-blue-500 text-blue-700',
